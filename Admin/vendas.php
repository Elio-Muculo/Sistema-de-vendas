   ...
   <div id="page-inner">
       ...
       <div class="row">
         ...
         <div class="col-md-4">
           <div class="card text-white bg-dark mb-3" style="max-width: 18rem; height: 250px;">
              <div class="card-header">Produto Mais Vendido</div>
                <div class="card-body">
                  ...
                  <p class="card-text"><?php echo  "Valor: ". $venda['preco']."MZN"?></p>
                </div>
            </div>
          </div>
          <?php
          ...
          <?php
          $sqlNew = "SELECT * FROM produtos ORDER BY data DESC LIMIT 1";
          $results = mysqli_query($connect, $sqlNew);
          $brandNew = mysqli_fetch_array($results);
           ?>
          <div class="col-md-4">
             <div class="card text-white bg-warning mb-3" style="max-width: 18rem; height: 250px;">
                <div class="card-header">Novo Produto</div>
                  <div class="card-body">
                    <h5 class="card-title"><?php echo  utf8_encode($brandNew['nome']);?></h5>
                    <p class="card-text"><?php echo  "Valor: ". $brandNew['preco']."MZN"?></p>
                  </div>
              </div>
         </div>
       </div>
