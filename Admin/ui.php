                                  ...
                                  <div class="modal-body">
                                    ...
                                    <form action="assets/php_action/admin.inc.php" method="post">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name="mail" id="exampleInputPassword2" placeholder="email">
                                        </div>
                                        <div class="form-group">
                                            <label for="exampleInputPassword1">Senha</label>
                                            <input type="text" class="form-control" name="pwd" id="exampleInputPassword3" placeholder="Senha">
                                        </div>
                              ...
                              <div class="modal-dialog" role="document">
                                <div class="modal-content">
                                  ...
                                  <div class="modal-footer">
                                    <form action="assets/php_action/restaurar.inc.php" method="POST">
